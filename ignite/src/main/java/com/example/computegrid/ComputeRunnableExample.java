 ...
 * <p>
 * Alternatively you can run {@link } in another JVM which will start node
...
public class ComputeRunnableExample {
    ...
    public static void main(String[] args) throws IgniteException {
        try (Ignite ignite = Ignition.start(new IgniteConfiguration().setClientMode(true).setPeerClassLoadingEnabled(true))) {
            System.out.println();
